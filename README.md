...
This project is based on a reference/starter implementation and was extended by me with cloud architecture, CI/CD automation, deployment, scaling, and monitoring on AWS.
